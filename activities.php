...
<head>
    ...
    <title>Activities | Maharishi</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="header">
            <div class="headerdiv">
                <video data-src="./assets/videos/Activities.mp4" type="video/mp4" autoplay muted loop preload="none">
                </video>
                <div class="headercntnt">
                    <img data-src="./assets/images/logo_main.png" class="lazy mb-4" height="100px" alt="">
                    <h6 class="mb-4" data-aos="fade-up" data-aos-delay="100">School Activities</h6>
                    <h3 class="mb-4" data-aos="fade-up" data-aos-delay="200">Fun, Creativity, and Lifelong Skills</h3>
        ...
        <div class="corevalues">
            <div class="corevaluesdiv">
                <div class="corevalueshead">
                    <h3 class="m-0" data-aos="fade-down">Activities</h3>
                </div>
