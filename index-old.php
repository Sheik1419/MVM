    ...
    <div class="main">
                    ...
                    <div class="splide__track">
                        <ul class="splide__list">
                            <li class="splide__slide">
                                ...
                                <h6 class="mb-4">Journeys of Growth, Discovery, and Friendship</h6>
                                <h3 class="mb-4">A Different School Of Thought</h3>
                                <button class="headbtn mb-4">Explore Our Programs <i
        ...
        <div class="about">
            <div class="aboutdiv pb-2">
                <div class="aboutleft">
                    <h2 class="m-0">Building Confidence Since 1977</h2>
                </div>
                <div class="aboutright">
                    ...
                    <button class="headbtn">Read More <i class="fas fa-arrow-right ps-1"></i></button>
                </div>
            </div>
            ...
            <div class="aboutcard row">
                <div class="col-sm-12 col-md-3 col-xl-3 px-3">
                    ...
                    <h6 class="m-0">Igniting the spirit of innovation, turning curiosity into creative breakthroughs.
                    </h6>
                </div>
                <div class="col-sm-12 col-md-3 col-xl-3 px-3">
                    <h3 class="mb-3">Compassionate</h3>
                    <h6 class="m-0">Where empathy meets action. Guiding heartfelt actions and community connections.
                    </h6>
                </div>
                <div class="col-sm-12 col-md-3 col-xl-3 px-3">
                    <h3 class="mb-3">Well Rounded</h3>
                    <h6 class="m-0">Crafting multifaceted excellence, diverse talents and balanced perspectives.</h6>
                </div>
                <div class="col-sm-12 col-md-3 col-xl-3 px-3">
                    <h3 class="mb-3">Courageous</h3>
                    <h6 class="m-0">Bold hearts, brave pursuits. Empowering students to lead with confidence and
                        boldness.</h6>
                </div>
            </div>
        </div>
        ...
        <div class="life">
            <div class="lifehead">
                <h3 class="m-0">Life On Campus</h3>
            </div>
            <div class="lifeimg">
                <img src="./assets/images/Life_On_Campus.png" width="100%" alt="">
            </div>
        </div>
        ...
        <div class="beyond">
            <div class="beyonddiv">
                <img src="./assets/images/logo_white.png" class="mb-4" height="100px" alt="">
                <h3 class="mb-3">Emerge, Evlove, Excel</h3>
                <h6 class="mb-4">GSIS isn't just a school - we are a community where student residences transform into
                ...
                <button class="headbtn">Beyond Academics <i class="fas fa-arrow-right ps-1"></i></button>
            </div>
        </div>
            ...
            <div class="learningdiv">
                ...
                <div class="learningcards">
                    ...
                    <div class="learningct">
                        <h5 class="mb-3">Learning</h5>
                        <h3 class="mb-3">Academic Excellence</h3>
                        <h6 class="m-0">Our commitment to excellence in education challenges students to realize their
                ...
                <div class="learningcards">
                    <div class="learningct">
                        <h5 class="mb-3">Creative</h5>
                        <h3 class="mb-3">Arts</h3>
                        <h6 class="m-0">Beyond aesthetics, our arts program nurtures creative intelligence and emotional
                ...
                <div class="learningcards">
                    ...
                    <div class="learningct">
                        ...
                        <h3 class="mb-3">Athletics</h3>
                        <h6 class="m-0">GSIS champions a diverse athletic program featuring archery, basketball, soccer,
                ...
                <div class="learningcards">
                    <div class="learningct">
                        <h5 class="mb-3">Spirit</h5>
                        <h3 class="mb-3">Going Beyond</h3>
                        <h6 class="m-0">More than an institution, we are a launching pad for personal growth. Find out
        ...
        <div class="cards">
            <div class="cardsdiv">
                <div class="card-1">
                    <h3 class="mb-3">AP Test Center Registration</h3>
                    <h6 class="mb-3">College Board's Advanced Placement Program® is recognized by universities around
                        the world as a standard of academic excellence.</h6>
                    <button class="headbtn">Read More <i class="fas fa-arrow-right ps-1"></i></button>
                </div>
                <div class="brdr"></div>
                <div class="card-1">
                    <h3 class="mb-3">Summer School</h3>
                    <h6 class="mb-3">Discover, Learn, and Grow this summer at Good Shepherd International School's
                        highly anticipated STEP BEYOND Summer Camp.</h6>
                    <button class="headbtn">Read More <i class="fas fa-arrow-right ps-1"></i></button>
                </div>
                <div class="brdr"></div>
                <div class="card-1">
                    <h3 class="mb-3">IB Manthan 2024</h3>
                    <h6 class="mb-3">Inspiring Tomorrow, Shaping Futures: Our Vision For The Future Of Education.</h6>
                    <button class="headbtn">Read More <i class="fas fa-arrow-right ps-1"></i></button>
                </div>
            </div>
        </div>
        ...
        <div class="message">
            <div class="messagediv">
                ...
                <div class="messageright">
                    <h5 class="mb-4">School Leadership</h5>
                    <h4 class="mb-4">Message From The Headmistress</h4>
                    <h6 class="mb-4">
                    ...
                    <h5 class="mb-2">Deepa Suresh</h5>
                    <h5 class="mb-3">Headmistress</h5>
                    <button class="headbtn">Read More <i class="fas fa-arrow-right ps-1"></i></button>
                </div>
            </div>
        </div>
        ...
        <div class="awards">
            <div class="awardshead">
                <h3 class="m-0">Awards & Accreditations</h3>
            </div>
            <div class="awardsdiv">
        ...
        <div class="campussays">
            <div class="campussaysdiv">
                ...
                <div class="campussaysright">
                    <h3 class="mb-4">What Our Campus Says</h3>
                    <h6 class="mb-4">
                    ...
                    <h6 class="mb-2">Dev Desai</h6>
                    <h6 class="m-0">Grade 12</h6>
                </div>
            </div>
        </div>
